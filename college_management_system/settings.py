...
SECRET_KEY = 'django-insecure-l5&krt87-=k06#2lwbn^rg$f0i6htuj2**e1zbpv9rf#y3u#*s'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME','college_management_system'),
        'USER': os.environ.get('DB_USER','root'),
        'PASSWORD' :os.environ.get('DB_PASSWORD','2354@Krishna'),
